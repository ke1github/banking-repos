            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="flex justify-between">
                  ...
                  <span className="font-semibold">{stock.fundamentals.pe}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-600">P/B Ratio</span>
                  <span className="font-semibold">{stock.fundamentals.pb}</span>
                </div>
                <div className="flex justify-between">
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-semibold">
                    {(
                      (stock.fundamentals.profit / stock.fundamentals.revenue) *
                      100
                    ).toFixed(1)}
                    %
                  </span>
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-semibold text-green-600">
                      +
                      {(
                        ((stock.analyst.target - stock.price) / stock.price) *
                        100
                      ).toFixed(1)}
                      %
                    </span>
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex-1">
                      <div className="text-sm font-medium">Rating Upgrades</div>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between items-center">
                    <span className="text-gray-600">Institutional Flow</span>
                    <Badge className="text-green-600 bg-green-50 border-green-200 border">
                      Buying
                    </Badge>
                  </div>
