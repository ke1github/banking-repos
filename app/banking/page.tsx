...
import MoneyManagement from "@/components/banking/MoneyManagement";
import {
  CreditCard,
  Banknote,
  ArrowUpRight,
        ...
        <CardContent>
          <Tabs defaultValue="accounts" className="w-full">
            <TabsList className="grid w-full max-w-md grid-cols-2">
              <TabsTrigger value="accounts">Accounts & Transfers</TabsTrigger>
              <TabsTrigger value="money-management">
                Money Management
              </TabsTrigger>
            </TabsList>
            ...
            <TabsContent value="money-management" className="pt-6">
              <MoneyManagement />
            </TabsContent>
          </Tabs>
        </CardContent>
